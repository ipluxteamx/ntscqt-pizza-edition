...
def random_ntsc(seed=None) -> Ntsc:
    ...
    ntsc._black_line_cut = bool(rnd.randint(0, 1))
    ntsc._black_line_width = int(rnd.triangular(0, 10, 0))
    return ntsc
