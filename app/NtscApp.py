...
from PyQt5.QtWidgets import QSlider, QHBoxLayout, QLabel, QCheckBox, QInputDialog, QPushButton, QLineEdit
...
class NtscApp(QtWidgets.QMainWindow, mainWindow.Ui_MainWindow):
    def __init__(self):
        ...
        self.strings = {
            ...
            "_black_line_width": self.tr("Black line width"),
        }
        ...
        self.add_slider("_black_line_width", 0, 500, pro=True)
        ...
        self.add_checkbox("_vhs_chroma_vert_blend", (3, 3), pro=True)
        self.add_checkbox("_vhs_svideo_out", (4, 3), pro=True)
        self.add_checkbox("_output_ntsc", (2, 3), pro=True)
        self.add_checkbox("_black_line_cut", (1, 3), pro=False)
